...
export function SocialIcon({ icon, className = "" }: SocialIconProps) {
  const icons: Record<string, JSX.Element> = {
    ...
    steam: (
      <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M11.979 0C5.678 0 .511 4.86.022 11.037l6.432 2.658c.545-.371 1.203-.59 1.912-.59.063 0 .125.004.188.006l2.861-4.142V8.91c0-2.495 2.028-4.524 4.524-4.524 2.494 0 4.524 2.031 4.524 4.524 0 2.494-2.03 4.524-4.524 4.524h-.008v2.993c2.022 0 3.944.818 5.322 2.201 1.377-1.383 2.195-3.305 2.195-5.327 0-4.916-3.997-8.891-8.913-8.891zm-6.231 14.391c-.922.925-2.19 1.485-3.586 1.485-1.397 0-2.665-.56-3.586-1.485-.922-.924-1.482-2.195-1.482-3.593 0-1.397.56-2.667 1.482-3.591.92-.925 2.189-1.485 3.586-1.485 1.396 0 2.665.56 3.586 1.485.921.924 1.481 2.194 1.481 3.591 0 1.398-.56 2.669-1.481 3.593z"/>
      </svg>
    ),
    github: (
      <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
